...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-apiconnect/node_modules/apiconnect/node_modules/debug/src/debug.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-apiconnect/node_modules/apiconnect/node_modules/debug/src/debug.js</span></h1>
    <h2>
        
        Statements: <span class="metric">51.81% <small>(43 / 83)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">17.24% <small>(5 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">62.5% <small>(5 / 8)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">51.9% <small>(41 / 79)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-apiconnect/node_modules/apiconnect/node_modules/debug/src/</a> &#187; debug.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">713</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  function debug() {
    // disabled?
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!debug.enabled) return;
&nbsp;
<span class="cstat-no" title="statement not covered" >    var self = debug;</span>
&nbsp;
    // set `diff` timestamp
...
<span class="cstat-no" title="statement not covered" >      args.unshift('%O');</span>
    }
&nbsp;
    // apply any `formatters` transformations
<span class="cstat-no" title="statement not covered" >    var index = 0;</span>
<span class="cstat-no" title="statement not covered" >    args[0] = args[0].replace(/%([a-zA-Z%])/g, <span class="fstat-no" title="function not covered" >function(match, format) {</span></span>
...
<span class="cstat-no" title="statement not covered" >    exports.formatArgs.call(self, args);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var logFn = debug.log || exports.log || console.log.bind(console);</span>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if ('function' === typeof exports.init) {
    exports.init(debug);
  }
&nbsp;
  return debug;
