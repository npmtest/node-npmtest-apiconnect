...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-apiconnect/node_modules/apiconnect/bin/cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-apiconnect/node_modules/apiconnect/bin/cli.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-apiconnect/node_modules/apiconnect/bin/</a> &#187; cli.js</div>
</div>
<div class="body">
...
&nbsp;
cli(opts).then(<span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  logger.debug('Command completed succesfully');</span>
<span class="cstat-no" title="statement not covered" >  return logger.exit(0);</span>
}).catch(<span class="fstat-no" title="function not covered" >function(err) {</span>
<span class="cstat-no" title="statement not covered" >  logger.debug('Command completed with error');</span>
...
<span class="cstat-no" title="statement not covered" >  return logger.exit(err.exitCode ? err.exitCode : 1);</span>
});
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
